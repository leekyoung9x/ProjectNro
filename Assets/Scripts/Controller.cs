				...
				case -37:
					{
						...
						for (int num31 = 0; num31 < num30; num31++)
						{
							...
							Char.myCharz().arrItemBody[num31].template = ItemTemplates.get(num32);
