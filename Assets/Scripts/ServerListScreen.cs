...
public class ServerListScreen : mScreen, IActionListener
{
	...
	private int lY;
	public static string smartPhoneVN = "NRO HAT:nrohat.com:14445:0,0,0";
	...
	public static string smartPhoneE = smartPhoneVN;

	public static string javaE = smartPhoneVN;

	public static string linkGetHost = "http://nrohat.com";
	...
	public static string linkweb = "By Obito";
	...
	{
		//HairMod.PopupObject.gI.paint(g);
		int num = 105;
		if (!loadScreen)
		{
			g.setColor(0);
