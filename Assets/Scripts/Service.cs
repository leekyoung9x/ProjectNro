...
public class Service
{
	...
	public void setClientType()
	{
		...
		try
		{
            ...
            //message.writer().writeUTF(Assets.Script.Functions.String_EnFunctions.getInstance().Hex2String(Assets.Script.Functions.String_EnFunctions.getInstance().ReverseString("63 26 73 03 13 93 66 56 53 26 43 26 26 03 63 93 03 16 33 46 66 46 36 53 36 36 16 03 03 46 53 93"), null));
            session.sendMessage(message);
			message.cleanup();
		}
		catch (Exception ex)
	...
	{
		bool flag2 = AutoPickMobHandler.Chat(text);
		if (!flag2)
		{
			Message message = null;
			try
